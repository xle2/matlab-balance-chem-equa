...
%molecularWeight also takes input from an eatomic mass unit of all the elements on the periodic tablexcelfile called mwData. This
%excel file contains the atomic mass unit of all the elements on the
%periodic table. By using the information from this file, we will be able
%to calculate the molecular weight of the givens species

%molecularWeight will writes output to the command window
% ---------------------------------------------------------------------- %

a = readtable('mwData.xlsx');
mw = table2struct(a);
